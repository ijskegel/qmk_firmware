...
/*
 * Row - column numbering for the left half of the keyboard, effectively creating a 5x7 matrix.
 * The right one is just a mirrored version of the left one.
 *
 *           ┌───┐┌───┐┌───┐     
 *┌────┐┌───┐│0,2││0,3││0,4│┌───┐
 *│0,0 ││0,1│└───┘└───┘└───┘│0,5│┌───┐
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
     ...
     KC_ESC  ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_ADPU ,        KC_ADEN ,KC_H    ,KC_J    ,KC_K    ,KC_L    ,KC_SCLN ,KC_QUOT ,
     KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_PGDN ,        KC_HOME ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,KC_RSFT ,
